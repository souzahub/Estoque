object FormEstoque_Novo: TFormEstoque_Novo
  Left = 522
  Top = 98
  Width = 707
  Height = 601
  ...
  object QueryNovos: TQuery
    DatabaseName = 'IBEstoqueTI'
    SQL.Strings = (
      'SELECT * FROM ESTOQUE')
    Left = 16
    Top = 72
    object QueryNovosCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'IBESTOQUETI.ESTOQUE.CODIGO'
    end
    object QueryNovosPRODUTO: TStringField
      FieldName = 'PRODUTO'
      Origin = 'IBESTOQUETI.ESTOQUE.PRODUTO'
      Size = 50
    end
    object QueryNovosPRECO: TFloatField
      FieldName = 'PRECO'
      Origin = 'IBESTOQUETI.ESTOQUE.PRECO'
    end
    object QueryNovosESTOQUE: TIntegerField
      FieldName = 'ESTOQUE'
      Origin = 'IBESTOQUETI.ESTOQUE.ESTOQUE'
    end
    object QueryNovosESTOQUE_NOVO: TStringField
      FieldName = 'ESTOQUE_NOVO'
      Origin = 'IBESTOQUETI.ESTOQUE.ESTOQUE_NOVO'
      Size = 14
    end
  end
  object dsQueryNovos: TDataSource
    DataSet = QueryNovos
    Left = 16
    Top = 128
  end
