object FormEstoque_Usados: TFormEstoque_Usados
  Left = 916
  Top = 296
  Width = 707
  Height = 601
  ...
  object QueryUsados: TQuery
    DatabaseName = 'IBEstoqueTI'
    SQL.Strings = (
      'SELECT * FROM ESTOQUE')
    Left = 8
    Top = 48
    object QueryUsadosCODIGO: TIntegerField
      FieldName = 'CODIGO'
      Origin = 'IBESTOQUETI.ESTOQUE.CODIGO'
    end
    object QueryUsadosPRODUTO: TStringField
      FieldName = 'PRODUTO'
      Origin = 'IBESTOQUETI.ESTOQUE.PRODUTO'
      Size = 50
    end
    object QueryUsadosPRECO: TFloatField
      FieldName = 'PRECO'
      Origin = 'IBESTOQUETI.ESTOQUE.PRECO'
    end
    object QueryUsadosESTOQUE_USADO: TStringField
      FieldName = 'ESTOQUE_USADO'
      Origin = 'IBESTOQUETI.ESTOQUE.ESTOQUE_USADO'
      Size = 14
    end
  end
  object dsQueryUsados: TDataSource
    DataSet = QueryUsados
    Left = 8
    Top = 88
  end
