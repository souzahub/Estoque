object FormMistoEstoque: TFormMistoEstoque
  Left = 198
  Top = 130
  Width = 619
  Height = 526
  ...
  object lbNProduto: TLabeledEdit
    Left = 40
    Top = 136
    Width = 297
    Height = 21
  ...
  object QueryProximoCodigo: TQuery
    DatabaseName = 'IBEstoqueTI'
    SQL.Strings = (
      'select CODIGO from ESTOQUE order by CODIGO desc')
    Left = 200
    Top = 32
    object QueryProximoCodigoCODIGO: TIntegerField
      FieldName = 'CODIGO'
